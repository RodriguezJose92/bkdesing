...
class sendData{  
    ...
    async updateTest(lastTest){
        ...
        /** Body */
        let body = {"idCompany":"414" , "typeTest":`${testUpdate}`};
    ...
    */
    ...
    /** Event viewer */
    eventView(){this.viewer == 0 && (this.viewer++)};
    ...
    eventAddToCar(){
        ...
        let btnAddToCar =  document.body.querySelector('.m-add-to-cart');
